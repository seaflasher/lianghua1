...
--
-- Table structure for table `fundhold17q2new`
--

DROP TABLE IF EXISTS `fundhold17q2new`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `fundhold17q2new` (
  `idx` int NOT NULL,
...
--
-- Dumping data for table `fundhold17q2new`
--

LOCK TABLES `fundhold17q2new` WRITE;
/*!40000 ALTER TABLE `fundhold17q2new` DISABLE KEYS */;
/*!40000 ALTER TABLE `fundhold17q2new` ENABLE KEYS */;
UNLOCK TABLES;
