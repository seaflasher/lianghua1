...
--
-- Table structure for table `fundhold18q4new`
--

DROP TABLE IF EXISTS `fundhold18q4new`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `fundhold18q4new` (
  `idx` int NOT NULL,
  ...
  PRIMARY KEY (`idx`,`stock_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `fundhold18q4new`
--

LOCK TABLES `fundhold18q4new` WRITE;
/*!40000 ALTER TABLE `fundhold18q4new` DISABLE KEYS */;
/*!40000 ALTER TABLE `fundhold18q4new` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-02-15 23:00:22
