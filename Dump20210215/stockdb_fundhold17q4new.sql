...
--
-- Table structure for table `fundhold17q4new`
--

DROP TABLE IF EXISTS `fundhold17q4new`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `fundhold17q4new` (
  `idx` int NOT NULL,
...
--
-- Dumping data for table `fundhold17q4new`
--

LOCK TABLES `fundhold17q4new` WRITE;
/*!40000 ALTER TABLE `fundhold17q4new` DISABLE KEYS */;
/*!40000 ALTER TABLE `fundhold17q4new` ENABLE KEYS */;
UNLOCK TABLES;
