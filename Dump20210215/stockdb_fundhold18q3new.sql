...
--
-- Table structure for table `fundhold18q3new`
--

DROP TABLE IF EXISTS `fundhold18q3new`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `fundhold18q3new` (
  `idx` int NOT NULL,
...
--
-- Dumping data for table `fundhold18q3new`
--

LOCK TABLES `fundhold18q3new` WRITE;
/*!40000 ALTER TABLE `fundhold18q3new` DISABLE KEYS */;
/*!40000 ALTER TABLE `fundhold18q3new` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-02-15 23:00:21
