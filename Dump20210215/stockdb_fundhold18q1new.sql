...
--
-- Table structure for table `fundhold18q1new`
--

DROP TABLE IF EXISTS `fundhold18q1new`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `fundhold18q1new` (
  `idx` int NOT NULL,
...
--
-- Dumping data for table `fundhold18q1new`
--

LOCK TABLES `fundhold18q1new` WRITE;
/*!40000 ALTER TABLE `fundhold18q1new` DISABLE KEYS */;
/*!40000 ALTER TABLE `fundhold18q1new` ENABLE KEYS */;
UNLOCK TABLES;
