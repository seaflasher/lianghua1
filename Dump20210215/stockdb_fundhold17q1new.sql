...
--
-- Table structure for table `fundhold17q1new`
--

DROP TABLE IF EXISTS `fundhold17q1new`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `fundhold17q1new` (
  `idx` int NOT NULL,
...
--
-- Dumping data for table `fundhold17q1new`
--

LOCK TABLES `fundhold17q1new` WRITE;
/*!40000 ALTER TABLE `fundhold17q1new` DISABLE KEYS */;
/*!40000 ALTER TABLE `fundhold17q1new` ENABLE KEYS */;
UNLOCK TABLES;
